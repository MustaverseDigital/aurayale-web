...
const DeckComponent: React.FC<DeckComponentProps> = ({
  ...
  return (
    <section className="px-3 sm:px-4 pb-4 pt-2 sm:pt-4">
      <div className="flex items-center justify-between mb-3 sm:mb-4">
        <h2 className="text-base sm:text-lg font-black text-[#050505]">Current Deck</h2>
      ...
      <div className="grid grid-cols-5 md:grid-cols-10 gap-2 sm:gap-3 pt-4 sm:pt-6 bg-white p-3 sm:p-4 rounded-xl border border-[#d6d6d6] shadow-[0_8px_24px_rgba(0,0,0,0.08)]">
